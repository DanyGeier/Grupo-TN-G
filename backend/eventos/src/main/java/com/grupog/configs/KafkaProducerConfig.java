...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, EventoSolidarioEvent> eventoSolidarioProducerFactory() {
        return new DefaultKafkaProducerFactory<>(baseProducerProps());
    }

    @Bean
    public KafkaTemplate<String, EventoSolidarioEvent> eventoSolidarioKafkaTemplate() {
        return new KafkaTemplate<>(eventoSolidarioProducerFactory());
    }

    @Bean
    public ProducerFactory<String, BajaEventoSolidarioEvent> bajaEventoProducerFactory() {
        return new DefaultKafkaProducerFactory<>(baseProducerProps());
    }
